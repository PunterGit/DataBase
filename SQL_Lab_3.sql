...
INSERT INTO T_EXEMP (ID_EMPLOYER, NAME, SURNAME, FATHER_NAME, 
  ...
  VALUES (1, 'Алексей', 'Мальцев', 'Юрьевич', '05.11.1982', 2, 1);
/*
  36
*/
ALTER TABLE T_EXEMP
...
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (1, 1, 'Вася', 'Фёдаров', 'Васильевич', '89158013456');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (2, 2, 'Петя', 'Козлов', 'Витальевич', '89158013456');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (3, 3, 'Максим', 'Зайцев', 'Дмитриевич', '89158013456');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (4, 3, 'Коля', 'Галяев', 'Григорьевич', '89158013456');
INSERT INTO T_CONTACT (ID_CONTACT, ID_CATERER, NAME, SURNAME, FATHER_NAME, TELEPHON)
  VALUES (5, 5, 'Дима', 'Чадов', 'Александрович', '89158013456');
